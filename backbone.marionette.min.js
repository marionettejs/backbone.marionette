...
[];this.vent=c.extend({},d.Events,b.BindTo);c.extend(this,a)};c.extend(b.Application.prototype,d.Events,{addInitializer:function(a){this.initializers.push(a)},start:function(a){this.trigger("initialize:before",a);for(var b=0;b<this.initializers.length;b++)(0,this.initializers[b])(a);this.trigger("initialize:after",a)},addRegions:function(a){if(!this.regions)this.regions={},this.addInitializer(c.bind(this._initializeRegions,this));var e=this.regions,d;for(d in a)if(a.hasOwnProperty(d)){var f=a[d];
e[d]="string"===typeof f?b.RegionManager.extend({el:f}):f}},_initializeRegions:function(){if(this.regions)for(var a in this.regions)this.regions.hasOwnProperty(a)&&(this[a]=new this.regions[a])}});b.TemplateManager={templates:{},get:function(a){var b=this.templates[a];b||(b=this.loadTemplate(a),this.templates[a]=b);return b},loadTemplate:function(a){return f(a)},clear:function(){var a=arguments.length;if(1<a)for(var b=0;b<a;b++)delete this.templates[arguments[b]];else this.templates={}}};var j=Array.prototype.slice,
i=d.View.extend;b.RegionManager.extend=i;b.Application.extend=i;c.extend(b.ItemView.prototype,b.BindTo);c.extend(b.CollectionView.prototype,b.BindTo);c.extend(b.Application.prototype,b.BindTo);return b}(Backbone,_,window.jQuery||window.Zepto||window.ender);
