...
c=a[d],this.route(e,d,c)}});c.Callbacks=function(){this.callbacks=[];this.callbackOptions={}};d.extend(c.Callbacks.prototype,{add:function(a){this.callbacks.push(a)},run:function(a){for(var b=this.callbacks.pop();b||0<this.callbacks.length;)b&&b.call(a,this.callbackOptions),b=this.callbacks.pop()},setOptions:function(a){this.callbackOptions=a}});c.Application=function(a){this.initCallbacks=new c.Callbacks;this.vent=d.extend({},e.Events,c.BindTo);d.extend(this,a)};d.extend(c.Application.prototype,
e.Events,{addInitializer:function(a){this.initCallbacks.add(a);this.isStarted&&this.initCallbacks.run(this)},start:function(a){this.isStarted=!0;this.initCallbacks.setOptions(a);this.trigger("initialize:before",a);this.initCallbacks.run(this);this.trigger("initialize:after",a);this.trigger("start",a)},addRegions:function(a){var b,d;for(d in a)a.hasOwnProperty(d)&&(b=a[d],b="string"===typeof b?c.RegionManager.extend({el:b}):b,this[d]=new b)}});c.TemplateManager={templates:{},get:function(a,b){var c=
this.templates[a];if(c)b&&b.call(this,c);else{var d=this;this.loadTemplate(a,function(c){d.templates[a]=c;b&&b.call(d,c)})}},loadTemplate:function(a,b){b.call(this,f(a))},clear:function(){var a=arguments.length;if(1<a)for(var b=0;b<a;b++)delete this.templates[arguments[b]];else this.templates={}}};var j=Array.prototype.slice,i=e.View.extend;c.RegionManager.extend=i;c.Application.extend=i;d.extend(c.ItemView.prototype,c.BindTo);d.extend(c.CollectionView.prototype,c.BindTo);d.extend(c.Application.prototype,
c.BindTo);return c}(Backbone,_,window.jQuery||window.Zepto||window.ender);
