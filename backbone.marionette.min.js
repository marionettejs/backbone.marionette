...
c){var b,d,e,f,g=[];for(e in c)g.unshift([e,c[e]]);f=g.length;for(var h=0;h<f;h++)e=g[h][0],d=g[h][1],b=a[d],this.route(e,d,b)}});b.Callbacks=function(){this.deferred=f.Deferred();this.promise=this.deferred.promise();this.callbacks=[];this.callbackOptions={}};d.extend(b.Callbacks.prototype,{add:function(a){var c=this;this.promise.then(function(){a.call(c.context,c.callbackOptions)})},run:function(a){this.context=a;this.deferred.resolve()},setOptions:function(a){this.callbackOptions=a}});b.Application=
function(a){this.initCallbacks=new b.Callbacks;this.vent=d.extend({},e.Events,b.BindTo);d.extend(this,a)};d.extend(b.Application.prototype,e.Events,{addInitializer:function(a){this.initCallbacks.add(a)},start:function(a){this.initCallbacks.setOptions(a);this.trigger("initialize:before",a);this.initCallbacks.run(this);this.trigger("initialize:after",a);this.trigger("start",a)},addRegions:function(a){var c,d;for(d in a)a.hasOwnProperty(d)&&(c=a[d],c="string"===typeof c?b.RegionManager.extend({el:c}):
c,this[d]=new c)}});b.TemplateManager={templates:{},get:function(a,c){var b=this.templates[a];if(b)c&&c.call(this,b);else{var d=this;this.loadTemplate(a,function(b){d.templates[a]=b;c&&c.call(d,b)})}},loadTemplate:function(a,b){b.call(this,f(a))},clear:function(){var a=arguments.length;if(0<a)for(var b=0;b<a;b++)delete this.templates[arguments[b]];else this.templates={}}};var j=Array.prototype.slice,i=e.View.extend;b.RegionManager.extend=i;b.Application.extend=i;d.extend(b.ItemView.prototype,b.BindTo);
d.extend(b.CollectionView.prototype,b.BindTo);d.extend(b.Application.prototype,b.BindTo);d.extend(b.RegionManager.prototype,b.BindTo);return b}(Backbone,_,window.jQuery||window.Zepto||window.ender);
