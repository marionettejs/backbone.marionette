...
arguments);this.closeRegions()},initializeRegions:function(){var a=this;c.each(this.regions,function(d,b){var c=new e.Marionette.RegionManager({el:d});a.regionManagers[b]=c;a[b]=c})},closeRegions:function(){var a=this;c.each(this.regionManagers,function(d,b){d.close();delete a[b]});delete this.regionManagers}});b.AppRouter=e.Router.extend({constructor:function(a){e.Router.prototype.constructor.call(this,a);if(this.appRoutes){var d=this.controller;a&&a.controller&&(d=a.controller);this.processAppRoutes(d,
this.appRoutes)}},processAppRoutes:function(a,d){var b,e,g,f,h=[];for(g in d)h.unshift([g,d[g]]);f=h.length;for(var i=0;i<f;i++)g=h[i][0],e=h[i][1],b=c.bind(a[e],a),this.route(g,e,b)}});b.BindTo={bindTo:function(a,d,b,c){c=c||this;a.on(d,b,c);this.bindings||(this.bindings=[]);this.bindings.push({obj:a,eventName:d,callback:b,context:c})},unbindAll:function(){c.each(this.bindings,function(a){a.obj.off(a.eventName,a.callback)});this.bindings=[]}};b.Callbacks=function(){this.deferred=f.Deferred();this.promise=
...
f(a))},clear:function(){var a=arguments.length;if(0<a)for(var b=0;b<a;b++)delete this.templates[arguments[b]];else this.templates={}}};var k=Array.prototype.slice,j=e.View.extend;b.RegionManager.extend=j;b.Application.extend=j;c.extend(b.ItemView.prototype,b.BindTo);c.extend(b.CollectionView.prototype,b.BindTo);c.extend(b.Application.prototype,b.BindTo);c.extend(b.RegionManager.prototype,b.BindTo);return b}(Backbone,_,window.jQuery||window.Zepto||window.ender);
