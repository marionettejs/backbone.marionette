...
if(this.collection)a={},a.items=this.collection.toJSON();this.model&&(a=this.model.toJSON());return a},template:function(){return e(this.options.template)},render:function(){var a;a=this.template;a=c.isFunction(a)?a.call(this):e(a);var f=this.serializeData();a=this.renderTemplate(a,f);e(this.el).html(a);if(this.onRender)this.onRender()},renderTemplate:function(a,f){return c.template(a.html(),f)},close:function(){this.unbindAll();this.unbind();this.remove();if(this.onClose)this.onClose()}});b.CollectionView=
