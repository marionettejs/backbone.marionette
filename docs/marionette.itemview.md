...
method has been called. Also triggered as "item:before:destroy" /
`onItemBeforeDestroy`.
...
Triggered just after the view has been destroyed. Also triggered
as "item:destroyed" / `onItemDestroy`.
