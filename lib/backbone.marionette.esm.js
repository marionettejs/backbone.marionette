...
var Region = MarionetteObject.extend({
  ...
  _attachView: function _attachView(view) {
    ...
    var isNodeAttached = this.Dom.hasEl(document.documentElement, this.el);
    var shouldTriggerAttach = !view._isAttached && isNodeAttached && !this._shouldDisableMonitoring();
