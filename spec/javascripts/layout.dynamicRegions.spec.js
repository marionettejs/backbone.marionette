describe('layout - dynamic regions', function() {
  ...
  describe('when adding a region to a layout then destroying the layout', function() {
    var layout, region, destroyHandler;
